...
| Fichier | Rôle |
|---------|------|
| `backend.mdc` | `main:app`, structure `routers/` / `services/` / `models/` (services : filtre, guard, conversationalist, orchestrateur, APIs, signaux, géocodage, export), `pipeline_log`, tests pytest + CI sans Supabase réel. |
